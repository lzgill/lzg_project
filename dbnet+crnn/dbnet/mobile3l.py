...
class MobileNetV3L(nn.Module):
    def __init__(self, in_channels=1, scale=0.5):
        ...
        # conv1
        self.conv1 = ConvBNACT(in_channels=in_channels, out_channels=self.make_divisible(inplanes * scale),
                               kernel_size=3, stride=2, padding=1, groups=1, act='hard_swish')
        i = 0
