'''
label align +  128 -> 8192*3 +attention
'''
...
from crnn_chs.attention import MultiHeadAttention
...
class CRNN(nn.Module):
    ...
    def __init__(self, channel=1, nclass=8192):
        ...
        self.attention = MultiHeadAttention(d_model=128, num_heads=8)
        ...
        self.fc9 = nn.Conv2d(in_channels=128, out_channels=8192*3, kernel_size=1)
        self.init_params()
